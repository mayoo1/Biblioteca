    ...
    <View style={styles.container}>
      {showImage ? (
        ...
        <View style={{ flex: 1 }}>
          ...
          <Text style={styles.subtitleText}>1.2.3. Ramo Administrativo</Text>
          <ScrollView style={styles.scrollView}>
            ...
            <View style={[styles.descriptionContainer, {width: width * 0.85}]}>
              ...
              Incluyen más de siglo y medio de procesos, sentencias, cuadrantes, actas, entradas y salidas de presos, conocimientos ejecutorias, 
              turnos, minutas, de contabilidad: libros mayores, diarios, de caja, etc.  
              </Text>
            </View>
