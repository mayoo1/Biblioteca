      ...
      <View style={styles.container}>
        {showImage ? (
          ...
          <View style={{ flex: 1 }}>
            ...
            <Text style={styles.subtitleText}>5.4.10. Felipe de la Rosa</Text>
            ...
            <ScrollView style={styles.scrollView}>
              ...
              <View style={[styles.descriptionContainer, {width: width * 0.85}]}>
                ...
                Su colección cuenta con 1,565 volúmenes con temas variados como psicología, ética, lógica, moral, literatura, historia y 
                teatro, editados en Paris, Italia, Argentina, Inglaterra, Estados Unidos, España y México por mencionar algunos.{'\n'}             
                </Text>
              </View>
