      ...
      <View style={styles.container}>
        {showImage ? (
          ...
          <View style={{ flex: 1 }}>
            ...
            <Text style={styles.subtitleText}>5.4.12 Araceli Ibarra Bellon</Text>
            ...
            <ScrollView style={styles.scrollView}>
              ...
              <View style={[styles.descriptionContainer, {width: width * 0.85}]}>
                <Text style={styles.descriptionText}>
                  Historiadora, catedrática de la Facultad de filosofía y letras de la Universidad de Guadalajara, e investigadora asidua de tiempo completo. 
                  Su colección es rica en estudios de filosofía, literatura e historia del comercio en México y en el extranjero, como feminista no podrían faltar varios trabajos sobre género.
                </Text>
              </View>
