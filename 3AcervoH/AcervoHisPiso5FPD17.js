      ...
      <View style={styles.container}>
        {showImage ? (
          ...
          <View style={{ flex: 1 }}>
            ...
            <Text style={styles.subtitleText}>5.4.17 Colecciones Alfonsa L. Fots Díaz</Text>
            ...
            <ScrollView style={styles.scrollView}>
              ...
              <View style={[styles.descriptionContainer, {width: width * 0.85}]}>
                <Text style={styles.descriptionText}>
                  Material con temática sobre agricultura, fitotecnia, tecnología, boletines y todo lo concerniente al cultivo y cuidado de la caña de azúcar.
                </Text>
              </View>
