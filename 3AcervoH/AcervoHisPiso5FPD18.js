      ...
      <View style={styles.container}>
        {showImage ? (
          ...
          <View style={{ flex: 1 }}>
            ...
            <Text style={styles.subtitleText}>5.4.18. Colección Alberto Gómez Barbosa</Text>
            ...
            <ScrollView style={styles.scrollView}>
              ...
              <View style={[styles.descriptionContainer, {width: width * 0.85}]}>
                ...
                A la edad de 10 años compro su primera cámara y desde entonces comenzó su fascinación por el arte de capturar las imágenes de la vida cotidiana, 
                locutor en radio (actividad que realiza hasta la fecha), pero su pasión sigue siendo la fotografía lo cual lo llevo a iniciar la fototeca en Jalisco.{'\n'}             
                </Text>
              </View>
