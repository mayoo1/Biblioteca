      ...
      <View style={styles.container}>
        {showImage ? (
          ...
          <View style={{ flex: 1 }}>
            ...
            <Text style={styles.subtitleText}>6.2.2. Colección de Tesaurus</Text>
            ...
            <ScrollView style={styles.scrollView}>
              ...
              <View style={[styles.descriptionContainer, {width: width * 0.85}]}>
                ...
                Tesauro es una herramienta para el control del vocabulario, teniendo en cuenta su significado puede ser una antología, un catálogo,  un índice o simplemente
                  un listado que presenta los términos que se utilizan para la representación de ciertos contenidos. Su finalidad es contribuir a la normalización de 
                  los términos; de este modo, se facilita la comprensión y la comunicación.{'\n'}
                </Text>
              </View>
