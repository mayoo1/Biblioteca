        ...
        {showImage ? (
          ...
          >
            <View style={styles.imageView}>
              <Image
                source={require('../fotos/craneo.jpg')}
                style={[styles.fullImage, {height: width * 0.8, width: width * 0.8}]}
              />
          ...
          <View style={{ flex: 1 }}>
            ...
            <ScrollView style={styles.scrollView}>
              ...
              <View style={[styles.descriptionContainer, {width: width * 0.85}]}>
                ...
                Formada por impresos mexicanos y europeos de estudios y prácticas médicas, del Siglo XVIII a mediados del XX.{'\n'}
                </Text>
              </View>
