        ...
        {showImage ? (
          ...
          <View style={{ flex: 1 }}>
            <View style={[styles.infoContainer, {height: width * 0.70, width: width * 0.95}]}>
              <Image
                source={require('../fotos/musica.jpg')}
                style={[styles.infoImage, {height: width * 0.45, width: width * 0.65}]}
              />
            ...
            <ScrollView style={styles.scrollView}>
              ...
              <View style={[styles.descriptionContainer, {width: width * 0.85}]}>
                ...
                Es está colección podemos encontrar partituras de reconocidos músicos y compositores como el Jalisciense Tomás Escobar, el compositor 
                Alemán Robert Schumann, Ludwig van Beethoven etc.{'\n'}
                </Text>
              </View>
