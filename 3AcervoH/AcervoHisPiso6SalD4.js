      ...
      <View style={styles.container}>
        {showImage ? (
          ...
          <View style={{ flex: 1 }}>
            ...
            <Text style={styles.subtitleText}>6.4.4. Fondo Jalisco Histórico</Text>
            ...
            <ScrollView style={styles.scrollView}>
              ...
              <View style={[styles.descriptionContainer, {width: width * 0.85}]}>
                ...
                Colección que se encontraba en el edificio contemporáneo, de la Biblioteca Pública del Estado de Jalisco “Juan José Arreola”, puesto que 
                las características del material y por la temporalidad de los libros, se tuvieron que trasladar al edificio histórico un total de 2,203 volúmenes, 
                la temática más destacada son los Informes de Gobierno del Estado de Jalisco desde 1828 hasta 1960.{'\n'}
                </Text>
              </View>
