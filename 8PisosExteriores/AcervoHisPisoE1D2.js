    ...
    <View style={styles.container}>
      {showImage ? (
        ...
        <View style={{ flex: 1 }}>
          ...
          <Text style={styles.subtitleText}>1.1.2. Ramo Criminal (1600-1821)</Text>
          ...
          <ScrollView style={styles.scrollView}>
            ...
            <View style={[styles.descriptionContainer, {width: width * 0.85}]}>
              ...
              Documentos referentes a las causas criminales o hechos de sangre y violencia que eran presentados ante la Audiencia y sus Alcaldes del Crimen. (2,723 registros).
              </Text>
            </View>
