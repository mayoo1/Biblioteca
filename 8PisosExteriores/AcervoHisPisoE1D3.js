      ...
      <View style={styles.container}>
        {showImage ? (
          ...
          <View style={{ flex: 1 }}>
            ...
            <Text style={styles.subtitleText}>1.1.3. Ramo Fiscal (1580-1847)</Text>
            ...
            <ScrollView style={styles.scrollView}>
              ...
              <View style={[styles.descriptionContainer, {width: width * 0.85}]}>
                ...
                Libros encuadernados en piel que incluyen asuntos relativos al real ensaye, caudales del ramo de peajes,   tabacos, papel sellado, renta de naipes, registro de alcabalas, entre otros.(1,863 registros). 
                </Text>
              </View>
