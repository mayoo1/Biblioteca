        ...
        <View style={{ borderWidth: 1, borderColor: 'gray', width: 320, marginLeft: 20, marginTop: 10 }} />
          ...
          <View style={{ width: '86.5%', marginLeft: '5%' }}>
            <Text style={{ color: 'black', fontSize: 18, lineHeight: 25, textAlign: 'justify', marginTop: 10 }}>
              ...
              <Text style={{fontWeight: 'bold'}}>Periódicos locales:</Text>

            </Text>
          
            <Text style={{ color: 'black', fontSize: 18, lineHeight: 25, textAlign: 'justify', marginTop: 10, marginLeft: 25 }}>
            • Informador{'\n'}
            • Occidental{'\n'}
            • Mural{'\n'}
            • Ocho columnas{'\n'}
          ...
          <Text style={{ fontWeight: 'bold', color: 'black', fontSize: 18, lineHeight: 25, textAlign: 'justify', marginTop: 10 }}>Periódicos nacionales:</Text>
            <Text style={{ color: 'black', fontSize: 18, lineHeight: 25, textAlign: 'justify', marginTop: 10, marginLeft: 25 }}>
            • Excelsior{'\n'}
            • Financiero{'\n'}
            • Jornada{'\n'}
          ...
          <Text style={{ fontWeight: 'bold', color: 'black', fontSize: 18, lineHeight: 25, textAlign: 'justify', marginTop: 10 }}>Periódicos extranjeros:</Text>
            <Text style={{ color: 'black', fontSize: 18, lineHeight: 25, textAlign: 'justify', marginTop: 10, marginLeft: 25 }}>
            • El País (España){'\n'}
            • Le monde (Francia){'\n'}
            • The New (E.U.){'\n'}
          ...
          <Image source={require('./fotos/Logo8.png')} style={{height: 80, width: 150, marginLeft: 20, marginTop: 20}} />
        </ScrollView>
      </View>
        )}
        </View>
