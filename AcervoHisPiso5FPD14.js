  ...
  render() {
    ...
    return (
      <View style={styles.container}>
        ...
        <Text style={{ fontWeight: 'bold', color: 'black', fontSize: 17, marginLeft: 20, marginTop: 10 }}>5.4.14 Fondo Preparatoria de Jalisco
        </Text>
        ...
        <View style={{ borderWidth: 1, borderColor: 'gray', width: 320, marginLeft: 20, marginTop: 10 }} />
          ...
          <View style={{ width: '86.5%', marginLeft: '5%' }}>
            <Text style={{ color: 'black', fontSize: 18, lineHeight: 25, textAlign: 'justify', marginTop: 10 }}>
              1689 libros antiguos que pertenecían a los Fondos Especiales de la biblioteca José Cornejo Franco de la Preparatoria 1, que hora se resguardarán en la biblioteca Pública del Estado de Jalisco "Juan José Arreola" 
            </Text>
            <View style={{ borderWidth: 1, borderColor: 'gray', width: 320, marginLeft: 20, marginTop: 10 }} />
          </View>
