  ...
  render() {
    ...
    return (
      <View style={styles.container}>
        ...
        <Text style={{ fontWeight: 'bold', color: 'black', fontSize: 17, marginLeft: 20, marginTop: 10 }}>5.4.8 Lorenzo Martínez Negrete
        </Text>
        ...
        <View style={{ borderWidth: 1, borderColor: 'gray', width: 320, marginLeft: 20, marginTop: 10 }} />
          ...
          <View style={{ width: '86.5%', marginLeft: '5%' }}>
            <Text style={{ color: 'black', fontSize: 18, lineHeight: 25, textAlign: 'justify', marginTop: 10 }}>
              Destacado jurista y catedrático de la Universidad de Guadalajara y de la Universidad Autónoma de Guadalajara, condecorado en la medalla 
              "Ignacio L. Vallarta". Falleció el 10 de octubre de 1971.
            </Text>
