  ...
  render() {
    ...
    return (
      <View style={styles.container}>
        ...
        <Text style={{ fontWeight: 'bold', color: 'gray', fontSize: 17, marginLeft: 20, marginTop: 10 }}>5.3 Fondo Histórico Siglo XX.
        </Text>
        ...
        <View style={{ borderWidth: 1, borderColor: 'gray', width: 320, marginLeft: 20, marginTop: 10 }} />
          ...
          <View style={{ width: '86.5%', marginLeft: '5%' }}>
            <Text style={{ color: 'black', fontSize: 18, lineHeight: 25, textAlign: 'justify', marginTop: 10 }}>
              Contiene diccionarios, almanaques, religión, psicología, filosofía, ciencias sociales, lenguas, ciencias naturales y matemáticas, tecnologías, artes y
              literatura.
            </Text>
