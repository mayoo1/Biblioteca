  ...
  render() {
    ...
    return (
      <View style={styles.container}>
        ...
        <Text style={{ fontWeight: 'bold', color: 'darkred', fontSize: 24, marginLeft: 20, marginTop: 10, width: '90%' }}>6.3.1 Obras Bibliográficas editadas entre los Siglos XVII y XX. Piso 6</Text>
        <Text style={{ fontWeight: 'bold', color: 'black', fontSize: 17, marginLeft: 20, marginTop: 10, width: '90%' }}>6.3.1. Obras Bibliográficas editadas entre los Siglos XVII y XX. 
        </Text>
