  ...
  render() {
    ...
    return (
      <View style={styles.container}>
        {showImage ? (
          <ImageBackground
            source={require('./fotos/Antiguo29.jpg')} 
        ...
        <Text style={{ fontWeight: 'bold', color: 'black', fontSize: 17, marginLeft: 20, marginTop: 10, width: '90%' }}>6.1.10. Colección Guía de Forasteros y Calendarios del Siglo XVII y XX.
        </Text>
        ...
        <View style={{ borderWidth: 1, borderColor: 'gray', width: 320, marginLeft: 20, marginTop: 10 }} />
          ...
          <View style={{ width: '86.5%', marginLeft: '5%' }}>
            <Text style={{ color: 'black', fontSize: 18, lineHeight: 25, textAlign: 'justify', marginTop: 10 }}>
              Publicaciones anuales que surgen de la necesidad propia de la capital novohispana, que contienen temas explícitos como los cambios del tiempo, las fiestas civiles,
              sobre todo las religiosas que dominaban la vida social de la época. {'\n'}
            </Text>
