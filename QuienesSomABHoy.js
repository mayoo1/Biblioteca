      ...
      <View style={styles.container}>
        ...
        <ScrollView style={styles.scrollView}>
          <View style={styles.contentContainer}>
            ...
            {'\n'}{'\n'}La diversificación de productos y formatos, físicos y/o virtuales, convierte a la Biblioteca en un componente esencial e irreemplazable de la infraestructura cultural, educativa e informativa del territorio. Además de ofrecer una amplia gama de recursos, también desempeña un papel crucial en la promoción de la alfabetización digital, la educación continua y la participación en la sociedad del conocimiento. Es el espacio donde la comunidad puede acceder a información, nutrir la curiosidad intelectual y participar en la cultura y el conocimiento.
